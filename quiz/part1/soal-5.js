...
Function akan memproses angka yang lebih dari satu digit menjadi satu digit dengan melakukan perkalian. Bila masih lebih dari satu digit, 
terus lakukan perkalian setiap digit-nya untuk pada akhirnya mendapatkan satu digit. Wajib menggunakan rekursif untuk berlatih rekursif, 
...
function kaliTerusRekursif(angka) {
    ...
    if(angka < 10) {
        ...
        console.log(`Rekursif: ${angka} = (angka % 10) ${angka % 10} + kaliTerusRekursif(Math.floor(angka/10)) ${angka} / 10 = ${Math.floor(angka/10)}`);
